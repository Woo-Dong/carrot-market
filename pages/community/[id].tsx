  ...
  return (
    <div className="">
      ...
      <div>
        ...
        <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 px-4 border-t border-b-[2px] w-full">
      ...
      <div className="px-4">
        <textarea
          rows={4}
          className="my-2 shadow-sm w-full focus:ring-orange-500 rounded-md border-gray-300 focus:border-orange-500"
        />
        <Button text="reply" large />
      </div>
    </div>
  );
};
